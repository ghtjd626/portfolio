...
| [0009](./0009-native-app-stack.md) | 네이티브 앱 스택: Expo Router + expo-sqlite | Accepted |
| [0010](./0010-deployment-and-delivery-architecture.md) | 배포·딜리버리 아키텍처 (local-first가 배포를 바꾼다) | Accepted |
